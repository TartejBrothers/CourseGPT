...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-secondary-50 pt-20 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      >
        <FeatureCard
          icon={<BookOpenIcon className="h-10 w-10 text-primary-500 mx-auto" />}
          title="Lesson Generator"
          description="Generate structured lessons with outcomes, key concepts, and examples using AI."
        />
        <FeatureCard
          icon={<SparklesIcon className="h-10 w-10 text-primary-500 mx-auto" />}
